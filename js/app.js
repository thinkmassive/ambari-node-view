...
app.service('MainCluster', function(Cluster) {
    var cluster_sample = '{"stack_version":"HDP-2.2", "hosts": ["http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/mgmt.example.com", "http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/master1.example.com", "http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/master2.example.com", "http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/worker01.example.com"], "hosts_info": [{"components":["HDFS_CLIENT","JOURNALNODE","MAPREDUCE2_CLIENT","MYSQL_SERVER","TEZ_CLIENT","YARN_CLIENT","ZOOKEEPER_CLIENT","ZOOKEEPER_SERVER"],"host_name":"mgmt.example.com","url":"http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/mgmt.example.com"},{"components":["APP_TIMELINE_SERVER","HDFS_CLIENT","HISTORYSERVER","JOURNALNODE","MAPREDUCE2_CLIENT","NAMENODE","RESOURCEMANAGER","TEZ_CLIENT","YARN_CLIENT","ZKFC","ZOOKEEPER_CLIENT","ZOOKEEPER_SERVER"],"host_name":"master1.example.com","url":"http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/master1.example.com"},{"components":["HDFS_CLIENT","JOURNALNODE","MAPREDUCE2_CLIENT","NAMENODE","RESOURCEMANAGER","TEZ_CLIENT","YARN_CLIENT","ZKFC","ZOOKEEPER_CLIENT","ZOOKEEPER_SERVER"],"host_name":"master2.example.com","url":"http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/master2.example.com"},{"components":["DATANODE","HDFS_CLIENT","MAPREDUCE2_CLIENT","NODEMANAGER","TEZ_CLIENT","YARN_CLIENT","ZOOKEEPER_CLIENT"],"host_name":"worker01.example.com","url":"http://mgmt.example.com:8080/api/v1/clusters/hdpcluster/hosts/worker01.example.com"}],"name":"hdpcluster","security_type":"NONE","stack_version":"HDP-2.3"}';
